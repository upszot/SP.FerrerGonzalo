...
function filtrarDatos() {
    ...
    //rango tiene -> Menor , Medio , Mayor500
    let rango=$('input:radio[name=rango]:checked').val();
    ...
    if(rango=="Menor"){
        datosFiltradosSelect = datosFiltradosSelect.filter(obj => obj.precio < 100000);
    }
    
    if(rango=="Medio"){
        datosFiltradosSelect = datosFiltradosSelect.filter(obj => obj.precio > 100000 );
         datosFiltradosSelect = datosFiltradosSelect.filter( obj => obj.precio < 500000   );
